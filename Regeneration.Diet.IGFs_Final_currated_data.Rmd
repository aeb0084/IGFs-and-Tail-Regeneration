...
outlierTest(lm(Rate_Reg~ Treatment*Week, data=early_reg, na.action=na.omit))

outlierTest(lm(Perc.Regeneration~ Treatment*Week, data=early_reg, na.action=na.omit))
...
## Print alternative view of results
```{r, print=F, evaluate=F, results=F}
